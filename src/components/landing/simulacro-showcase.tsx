...
export function SimulacroShowcase() {
  ...
  return (
    <div ref={ref} className="mx-auto w-full max-w-xl">
      {/* De vuelta al registro navy: la hoja de resultados sobre el papel */}
      <div
        className={cn(
          "at",
          visible && "animate-fade-up",
          "relative overflow-hidden rounded-lg border border-border bg-card shadow-[0_24px_48px_-24px_rgba(15,23,42,0.45)]",
        )}
